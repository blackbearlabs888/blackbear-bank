...
function TestimonialCard({ t }: { t: PublicTestimonial }) {
  return (
    <Card className="flex-shrink-0 w-[280px] sm:w-[320px] border-border/50 hover:shadow-md transition-shadow duration-300 bg-background py-0 gap-0">
...
export default function TestimonialsSection() {
  ...
  return (
    <section className="relative py-20 md:py-24 z-10" aria-labelledby="testimonials-heading">
      <div className="container mx-auto px-4 mb-10">
        <div className="text-center">
          <p className="text-sm font-medium text-primary mb-3">Testimoni</p>
