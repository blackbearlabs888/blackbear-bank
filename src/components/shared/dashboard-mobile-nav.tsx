...
const ownerMoreItems = [
  { href: '/owner/dashboard/notifications', label: 'Notifikasi Partner', icon: MessageSquare },
  { href: '/owner/dashboard/fees', label: 'Pengaturan Fee', icon: Percent },
  { href: '/owner/dashboard/broadcast', label: 'Broadcast', icon: Megaphone },
  { href: '/owner/dashboard/settings', label: 'Konfigurasi', icon: Settings },
];
