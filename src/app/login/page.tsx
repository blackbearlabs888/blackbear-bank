...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      // Redirect based on ACTUAL role from server (not the selected role from form)
      const actualRole = result.data.user.role
      const redirectPath = actualRole === 'OWNER' ? '/owner/dashboard' : '/partner/dashboard'
